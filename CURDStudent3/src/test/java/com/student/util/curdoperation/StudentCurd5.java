...
public class StudentCurd5 extends TestBase {
    static String firstName = "rima" + TestUtils.getRandomValue();
    static String lastname = "datta" + TestUtils.getRandomValue();

    static String email = TestUtils.getRandomValue()+ "@yahoo.com";

    static String programme = "disaster management";
    ...
    public void getStudentInfoById() {
        //http://localhost:8080/student/37
    ...
    public void test001() {
        ...
        courseList.add("Disaster Preparedness");
        courseList.add("Phd");
    ...
    public void test004(){
        ...
        StudentPojo studentpojo = new StudentPojo();
        studentpojo.setFirstName("rima");
        studentpojo.setLastName("datta");
        studentpojo.setEmail("rimadatta333@yahoo.com");
        studentpojo.setProgramme("Disaster Management");
        studentpojo.setCourses(courseList);
